...
export default {
  ...
  data() {
    return {
      ...
      activeColor: '#0f59a4',
      tabList: [
        { text: '首页', icon: 'home', url: '/pages/index/WorkerIndex/index' },
        { text: '市场', icon: 'shop', url: '/pages/index/WorkerIndex/market' },
        { text: '任务', icon: 'calendar', url: '/pages/task/WorkerTask/task' },
        { text: '我的', icon: 'person', url: '/pages/index/WorkerIndex/mine' }
      ]
    }
  },
  methods: {
